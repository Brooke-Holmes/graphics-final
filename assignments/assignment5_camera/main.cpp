...
#include <..\core\bh\shader.h>
#include <bh/shader.cpp>

void framebufferSizeCallback(GLFWwindow* window, int width, int height);
void moveCamera(GLFWwindow* window, bh::Camera* camera, bh::CameraControls* controls, float deltaTime);
